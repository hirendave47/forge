...
const TRANSITIONS: Record<TaskState, readonly TaskState[]> = {
	CREATED: ["ENABLED", "DISABLED", "DUE", "ACQUIRING", "RUNNING", "SKIPPED", "FAILED", "CANCELLED"],
	ENABLED: ["DISABLED", "DUE", "ACQUIRING", "RUNNING", "CANCEL_REQUESTED", "CANCELLED"],
	DISABLED: ["ENABLED", "CANCELLED"],
	DUE: ["ACQUIRING", "RUNNING", "SKIPPED", "CANCEL_REQUESTED", "CANCELLED", "FAILED"],
	ACQUIRING: ["RUNNING", "SKIPPED", "FAILED", "TIMED_OUT", "CANCEL_REQUESTED", "CANCELLED"],
	RUNNING: ["VERIFYING", "SUCCEEDED", "FAILED", "TIMED_OUT", "CANCEL_REQUESTED", "CANCELLED"],
	VERIFYING: ["SUCCEEDED", "FAILED", "TIMED_OUT", "CANCEL_REQUESTED", "CANCELLED"],
	SUCCEEDED: ["ENABLED", "DISABLED", "CANCELLED", "DUE"],
	FAILED: ["RETRY_WAIT", "ENABLED", "DISABLED", "CANCELLED", "DUE"],
	RETRY_WAIT: ["DUE", "ACQUIRING", "CANCEL_REQUESTED", "CANCELLED"],
	CANCEL_REQUESTED: ["CANCELLED", "FAILED"],
	CANCELLED: [],
	SKIPPED: ["ENABLED", "DUE", "DISABLED"],
	TIMED_OUT: ["RETRY_WAIT", "ENABLED", "DISABLED", "CANCELLED", "DUE"],
};
