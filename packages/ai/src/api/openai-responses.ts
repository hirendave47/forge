...
// OpenAI Responses rejects max_output_tokens below 16: https://github.com/hirendave47/forge/issues/6265
...
function createClient(
	...
	const compat = getCompat(model);
	const headers: ProviderHeaders = { "User-Agent": getForgeUserAgent(), ...model.headers };
