...
// live under "@earendil-works/forge-ai/providers/*", API implementations under
// "@earendil-works/forge-ai/api/*", the old global API under
// "@earendil-works/forge-ai/compat".
