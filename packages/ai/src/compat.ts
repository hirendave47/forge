/**
 * Temporary compatibility entrypoint preserving the old global forge-ai API
 ...
 *
 * Existing apps switch imports from "@earendil-works/forge-ai" to
 * "@earendil-works/forge-ai/compat" unchanged; new code uses `createModels()`
...
export * from "./api/forge-messages.lazy.ts";
...
import { forgeMessagesApi } from "./api/forge-messages.lazy.ts";
...
/** @deprecated Static catalog read. Use `getBuiltinModel` from "@earendil-works/forge-ai/providers/all" or `Models.getModel()`. */
export const getModel = getBuiltinModel;

/** @deprecated Static catalog read. Use `getBuiltinModels` from "@earendil-works/forge-ai/providers/all" or `Models.getModels()`. */
export const getModels = getBuiltinModels;

/** @deprecated Static catalog read. Use `getBuiltinProviders` from "@earendil-works/forge-ai/providers/all" or `Models.getProviders()`. */
...
const BUILTIN_APIS: [Api, ProviderStreams][] = [
	...
	["forge-messages", forgeMessagesApi()],
];
