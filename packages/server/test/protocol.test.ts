import type { Api, AssistantMessage, Model, ToolCall, ToolResultMessage, UserMessage } from "@earendil-works/forge-ai";
import { encodeServerMessage, PROTOCOL_VERSION } from "@earendil-works/forge-protocol";
...
describe("forge-ai protocol bridge", () => {
