...
For non-Windows cross-builds, or for custom Windows toolchains, set `FORGE_TUI_WIN32_TOOLCHAIN=mingw` and provide MinGW-compatible compilers:

```sh
FORGE_TUI_WIN32_TOOLCHAIN=mingw \
