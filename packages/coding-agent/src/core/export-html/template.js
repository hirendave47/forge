    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="forge-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="forge-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'forge-share:v1:sidebar-width';
