...
export interface ExtensionUIContext {
	 ...
	 * extend `CustomEditor` from `@earendil-works/forge-coding-agent` and call
	 * `super.handleInput(data)` for keys you don't handle.
	 *
	 * @example
	 * ```ts
	 * import { CustomEditor } from "@earendil-works/forge-coding-agent";
	 *
...
/** Configuration for registering a provider via forge.registerProvider(). */
...
export type ExtensionFactory = (forge: ExtensionAPI) => void | Promise<void>;
...
export interface ExtensionRuntimeState {
	...
	/** Native forge-ai provider registrations queued during extension loading, processed when runner binds. */
...
/**
 * Action implementations for forge.* API methods.
