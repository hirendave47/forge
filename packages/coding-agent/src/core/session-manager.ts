...
import { type ImageContent, type Message, type TextContent, type Usage, uuidv7 } from "@earendil-works/forge-ai";
...
export interface CompactionEntry<T = unknown> extends SessionEntryBase {
	...
	usage?: Usage;
	/** True if generated by an extension, undefined/false if forge-generated (backward compatible) */
	fromHook?: boolean;
}
...
export interface BranchSummaryEntry<T = unknown> extends SessionEntryBase {
	...
	usage?: Usage;
	/** True if generated by an extension, false if forge-generated */
	fromHook?: boolean;
}
 ...
 * Encodes cwd into a safe directory name under ~/.forge/agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.forge/agent/sessions/<encoded-cwd>/).
	 */
