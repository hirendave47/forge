...
import type { Transport } from "@earendil-works/forge-ai";
import type { TuiMode as RendererTuiMode, ScrollViewScrollbar } from "@earendil-works/forge-tui";
...
export class SettingsManager {
	...
	getClearOnShrink(): boolean {
		...
		return process.env.FORGE_CLEAR_ON_SHRINK === "1";
	}
	...
	getShowHardwareCursor(): boolean {
		return this.settings.showHardwareCursor ?? process.env.FORGE_HARDWARE_CURSOR === "1";
	}
