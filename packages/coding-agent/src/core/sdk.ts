...
import { Agent, type AgentMessage, setDefaultStreamFn, type ThinkingLevel } from "@earendil-works/forge-agent-core";
import { clampThinkingLevel, type Message, type Model, streamSimple } from "@earendil-works/forge-ai/compat";
...
// provider-agnostic and does not import forge-ai/compat itself.
setDefaultStreamFn(streamSimple);

export interface CreateAgentSessionOptions {
	/** Working directory for project-local discovery. Default: process.cwd() */
	cwd?: string;
	/** Global config directory. Default: ~/.forge/agent */
	agentDir?: string;
	 ...
	 *
	 * When omitted, forge uses the `defaultTools` setting for the initial built-in
