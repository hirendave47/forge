...
import type { AgentMessage, StreamFn, ThinkingLevel } from "@earendil-works/forge-agent-core";
import {
	contentText,
	type RetryCallbacks,
	type RetryPolicy,
...
import type { AssistantMessage, Context, Model, SimpleStreamOptions, Usage } from "@earendil-works/forge-ai/compat";
import { completeSimple } from "@earendil-works/forge-ai/compat";
...
function extractFileOperations(
	...
	// Collect from previous compaction's details (if forge-generated)
