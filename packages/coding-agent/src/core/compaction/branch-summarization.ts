...
import type { AgentMessage, StreamFn } from "@earendil-works/forge-agent-core";
import type { RetryCallbacks, RetryPolicy } from "@earendil-works/forge-ai";
import { contentText } from "@earendil-works/forge-ai";
import type { Model, SimpleStreamOptions, Usage } from "@earendil-works/forge-ai/compat";
import {
	convertToLlm,
...
export function prepareBranchEntries(entries: SessionEntry[], tokenBudget: number = 0): BranchPreparation {
	...
	// Only extract from forge-generated summaries (fromHook !== true), not extension-generated ones
