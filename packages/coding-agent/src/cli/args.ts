	...
	const extensionFlagsText =
		extensionFlags && extensionFlags.length > 0
			? `\n${chalk.bold("Extension CLI Flags:")}\n${extensionFlags
					...
					.join("\n")}\n`
			: "";
	console.log(`${chalk.bold(APP_NAME)} — Autonomous AI Agent Framework for Linux
...
${chalk.bold("Built-in Tool Names:")}
  ...
  wait_interval     - Pause execution for a specified duration in seconds
  send_notification - Send progress updates or summaries via email/webhook
`);
}
