import { ProcessTerminal, setKeybindings, type TUI, TuiMainScreen } from "@earendil-works/forge-tui";
...
const OFFICIAL_PACKAGE_NAME = "@earendil-works/forge-coding-agent";
const OFFICIAL_APP_NAME = "forge";
const OFFICIAL_CONFIG_DIR_NAME = ".forge";
 ...
 * - this is the official Forge distribution (not a fork/rebrand)
 * - experimental features are enabled (FORGE_EXPERIMENTAL=1)
