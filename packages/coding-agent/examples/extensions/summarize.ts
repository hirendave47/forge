import { uuidv7 } from "@earendil-works/forge-ai";
import type { ExtensionAPI, ExtensionCommandContext } from "@earendil-works/forge-coding-agent";
import { DynamicBorder, getMarkdownTheme } from "@earendil-works/forge-coding-agent";
import { Container, Markdown, matchesKey, Text } from "@earendil-works/forge-tui";
...
export default function (forge: ExtensionAPI) {
	forge.registerCommand("summarize", {
