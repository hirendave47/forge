 ...
 * Commands Extension
 *
 * Demonstrates the forge.getCommands() API by providing a /commands command
...
import type { ExtensionAPI, SlashCommandInfo } from "@earendil-works/forge-coding-agent";

export default function commandsExtension(forge: ExtensionAPI) {
	forge.registerCommand("commands", {
