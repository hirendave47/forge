...
Play DOOM as an overlay in forge. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
forge --extension ./examples/extensions/doom-overlay
```
...
- [forge-doom](https://github.com/hirendave47/forge-doom) for the original forge integration
