 ...
 *
 * Shows forge.events for communication between extensions. One extension
...
export default function (forge: ExtensionAPI) {
	...
	forge.events.on("my:notification", (data) => {
