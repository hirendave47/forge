...
import { Text, type TUI } from "@earendil-works/forge-tui";
...
describe("ToolExecutionComponent parity", () => {
	...
	for (const scenario of [
		...
		{
			title: "AGENTS.md",
			path: join(process.cwd(), ".forge", "AGENTS.md"),
			content: "Hidden resource instructions",
			compact: "read resource .forge/AGENTS.md",
			hidden: "Hidden resource instructions",
			absent: undefined,
		},
		{
			title: "AGENTS.override.md",
			path: join(process.cwd(), ".forge", "AGENTS.override.md"),
			content: "Hidden override instructions",
			compact: "read resource .forge/AGENTS.override.md",
	...
	for (const scenario of [
		...
		{ title: "Forge documentation", path: getReadmePath(), compact: "read docs README.md:120-329" },
	] as const) {
