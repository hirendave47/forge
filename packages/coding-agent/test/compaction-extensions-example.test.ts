...
vi.mock("@earendil-works/forge-coding-agent", () => ({
...
describe("Documentation example", () => {
	it("custom compaction example should type-check correctly", () => {
		...
		const exampleExtension = (forge: ExtensionAPI) => {
			forge.on("session_before_compact", async (event: SessionBeforeCompactEvent, ctx) => {
	...
	it("compact event should have correct fields", () => {
		const checkCompactEvent = (forge: ExtensionAPI) => {
			forge.on("session_compact", async (event: SessionCompactEvent) => {
