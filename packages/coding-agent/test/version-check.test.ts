...
const originalSkipVersionCheck = process.env.FORGE_SKIP_VERSION_CHECK;
...
afterEach(() => {
	...
	if (originalSkipVersionCheck === undefined) {
		...
		process.env.FORGE_SKIP_VERSION_CHECK = originalSkipVersionCheck;
	}
});
...
describe("version checks", () => {
	...
	it("disables automatic upstream version checks for the fork", async () => {
	...
	it("keeps automatic version checks disabled", async () => {
