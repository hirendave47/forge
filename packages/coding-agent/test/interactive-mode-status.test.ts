...
import { type AutocompleteProvider, CombinedAutocompleteProvider } from "@earendil-works/forge-tui";
...
describe("InteractiveMode.showLoadedResources", () => {
	...
	function createExtensionFixtures(): ExtensionFixture[] {
		return [
			{
				path: "/tmp/project/.forge/extensions/answer.ts",
				sourceInfo: createSourceInfo("/tmp/project/.forge/extensions/answer.ts", {
					source: "local",
					scope: "project",
					origin: "top-level",
					baseDir: "/tmp/project/.forge/extensions",
				}),
			},
			{
				path: "/tmp/project/.forge/extensions/local-index/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.forge/extensions/local-index/index.ts", {
					source: "local",
					scope: "project",
					origin: "top-level",
					baseDir: "/tmp/project/.forge/extensions",
			...
			{
				path: "/tmp/project/.forge/npm/node_modules/forge-markdown-preview/extensions/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.forge/npm/node_modules/forge-markdown-preview/extensions/index.ts",
					{
						source: "npm:forge-markdown-preview",
						scope: "project",
						origin: "package",
						baseDir: "/tmp/project/.forge/npm/node_modules/forge-markdown-preview",
					},
				),
			},
			{
				path: "/tmp/project/.forge/npm/node_modules/@scope/forge-scoped/extensions/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.forge/npm/node_modules/@scope/forge-scoped/extensions/index.ts",
					{
						source: "npm:@scope/forge-scoped",
						scope: "project",
						origin: "package",
						baseDir: "/tmp/project/.forge/npm/node_modules/@scope/forge-scoped",
					},
				),
			},
			{
				path: "/tmp/project/.forge/git/github.com/HazAT/forge-interactive-subagents/extensions/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.forge/git/github.com/HazAT/forge-interactive-subagents/extensions/index.ts",
					{
						source: "git:github.com/HazAT/forge-interactive-subagents",
						scope: "project",
						origin: "package",
						baseDir: "/tmp/project/.forge/git/github.com/HazAT/forge-interactive-subagents",
					},
				),
			},
			{
				path: "/tmp/project/.forge/git/github.com/HazAT/forge-interactive-subagents/extensions/subagents/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.forge/git/github.com/HazAT/forge-interactive-subagents/extensions/subagents/index.ts",
					{
						source: "git:github.com/HazAT/forge-interactive-subagents",
						scope: "project",
						origin: "package",
...
"[Extensions]
  @scope/forge-scoped, answer.ts, cli-extension.ts, forge-markdown-preview, HazAT/forge-interactive-subagents, HazAT/forge-interactive-subagents:subagents, local-index, user-index"`);
	});
...
"[Extensions]
  forge-markdown-preview"`);
	...
	test("labels npm sibling extensions relative to the declaring package", () => {
		const extensions: ExtensionFixture[] = [
			{
				path: "/tmp/project/.forge/npm/node_modules/primary-package/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.forge/npm/node_modules/primary-package/index.ts", {
					source: "npm:primary-package",
					scope: "project",
					origin: "package",
					baseDir: "/tmp/project/.forge/npm/node_modules/primary-package",
				}),
			},
			{
				path: "/tmp/project/.forge/npm/node_modules/sibling-package/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.forge/npm/node_modules/sibling-package/index.ts", {
					source: "npm:primary-package",
					scope: "project",
					origin: "package",
					baseDir: "/tmp/project/.forge/npm/node_modules/primary-package",
...
"[Extensions]
  primary-package, primary-package:../sibling-package"`);
	...
	test("labels Windows npm sibling extensions relative to the declaring package", () => {
		const primaryPath = "C:\\Users\\me\\.forge\\agent\\npm\\node_modules\\primary-package\\index.ts";
		const siblingPath = "C:\\Users\\me\\.forge\\agent\\npm\\node_modules\\sibling-package\\index.ts";
		const baseDir = "C:\\Users\\me\\.forge\\agent\\npm\\node_modules\\primary-package";
		const extensions: ExtensionFixture[] = [
			{
				path: primaryPath,
...
"[Extensions]
  project
    /tmp/project/.forge/extensions/answer.ts
    /tmp/project/.forge/extensions/local-index
    git:github.com/HazAT/forge-interactive-subagents
      extensions
      extensions/subagents
    npm:@scope/forge-scoped
      extensions
    npm:forge-markdown-preview
      extensions
  user
  ...
  path
	...
	test("shows context paths relative to cwd while preserving full external paths", () => {
		const home = homedir();
		const cwd = path.join(home, "Development", "forge");
		const fakeThis = createShowLoadedResourcesThis({
			quietStartup: false,
			cwd,
			contextFiles: [
				{ path: path.join(home, ".forge", "agent", "AGENTS.md") },
		...
		expect(output).toContain("~/.forge/agent/AGENTS.md, AGENTS.md");
	...
	test("shows system prompt context paths before project context files", () => {
		...
		const fakeThis = createShowLoadedResourcesThis({
			quietStartup: false,
			cwd,
			systemPromptSource: { path: path.join(cwd, ".forge", "SYSTEM.md") },
			appendSystemPromptSources: [{ path: path.join(cwd, ".forge", "APPEND_SYSTEM.md") }],
		...
		const output = renderAll(fakeThis.loadedResourcesContainer).replace(/\\/g, "/");
		expect(output).toContain("[Context]");
		expect(output).toContain(".forge/SYSTEM.md, .forge/APPEND_SYSTEM.md, AGENTS.md");
	});
	...
	test("shows full context paths when expanded", () => {
		...
		const output = renderAll(fakeThis.loadedResourcesContainer).replace(/\\/g, "/");
		expect(output).toContain("[Context]");
		expect(output).toContain("~/.forge/agent/AGENTS.md");
		expect(output).toContain("~/Development/forge/AGENTS.md");
		expect(output).not.toContain("~/.forge/agent/AGENTS.md, AGENTS.md");
	});
