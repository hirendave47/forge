...
import type { AssistantMessage, Context, Model } from "@earendil-works/forge-ai";
...
vi.mock("@earendil-works/forge-ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@earendil-works/forge-ai/compat")>();
	return {
		...actual,
