...
const originalOffline = process.env.FORGE_OFFLINE;
...
afterEach(() => {
	if (originalOffline === undefined) delete process.env.FORGE_OFFLINE;
	else process.env.FORGE_OFFLINE = originalOffline;
});
