...
const DEFAULT_SESSIONS_DIR = path.join(homedir(), ".forge/agent/sessions");
const DEFAULT_ACTIVE_EDIT_EXTENSION_PATH = path.join(homedir(), ".forge/agent/extensions/edit.ts");
...
Options:
  --sessions-dir <path>  Sessions directory (default: ~/.forge/agent/sessions)
